...
def check_workflow_status():
    ...
    try:
        ...
        print(
            "3. Recent run should show your commit: 'docs: test cross-repository sync functionality'"
        )
        ...
        print(
            "curl -s https://api.github.com/repos/PipFoweraker/pdoom1-website/contents/docs/ECOSYSTEM_OVERVIEW.md"
        )
        print(
            "curl -s https://api.github.com/repos/PipFoweraker/pdoom-data/contents/docs/ECOSYSTEM_OVERVIEW.md"
        )
