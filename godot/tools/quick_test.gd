...
func _init():
	...
	if Engine.has_singleton("GameState"):
		print("[[OK]] GameState singleton found")
	elif root and root.has_node("/root/GameState"):
		print("[[OK]] GameState autoload found at /root/GameState")
	else:
	...
	if root and root.has_node("/root/GameManager"):
		print("[[OK]] GameManager autoload found")
	else:
	...
	if GameStateClass:
		print("[[OK]] GameState script loaded successfully")
		...
		if gs:
			...
			if gs.has_method("initialize"):
				...
				print("[[OK]] GameState properties accessible")
			else:
				print("[!] GameState doesn't have initialize() method")

			gs.free()
		else:
			print("[[X]] Failed to create GameState instance")
	else:
		print("[[X]] Failed to load GameState script")
