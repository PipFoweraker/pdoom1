...
This pairs with `MUSIC_DESIGN.md` (the adaptive system) and `TRACK_ANALYSIS.md` (the dissection
method). The beloved-track deep-dive output lives in `tools/music/library/` (7-beat 3+2+2 decode)
and `tools/music/DIRECTION_NOTES.md`. Main theme lives in the title / main menu screen.
