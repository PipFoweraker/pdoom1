...
Horizon: **2026-08-09** (the prose scan reports dates at or after this; roll it
...
| 2026-08-10 | task | Book the half-day audit-mechanics workshop, target window opens | pip | 2, 0 | `docs/rulings/RULINGS.md:259` |
...
| 2026-08-14 | cadence | Friday push -- an ordinary patch day, epoch-breaking changes only if player experience demands it | pip | 0 | `docs/calendar/COMMITMENTS.md:174` |
| 2026-08-14 | cadence | Rektango 17:30 -- the weekly anchor, a hard stop | pip | 0 | `docs/calendar/COMMITMENTS.md:176` |
| 2026-08-14 | falsifier | P7 falsifier: open-issue count. At or above 208 means the weekly close-sweep did not happen and the triage lane must not re-run | pdoom1-seat | 1, 0 | `docs/POSTMORTEM_2026-08-07_CAPTURE.md:774` |
| 2026-08-14 | falsifier | P8 falsifier: grep -n MEASURED docs/art/SEED_ART_COST_MODEL.md. Any survivor beside a log-derived cost is F10 repeating one week on | pdoom1-seat | 1, 0 | `docs/POSTMORTEM_2026-08-07_CAPTURE.md:776` |
| 2026-08-14 | falsifier | P9, the pack's OWN falsifier: if none of P1-P8 started and no issue cites this document, stop producing printed packs | pdoom1-seat | 1, 0 | `docs/POSTMORTEM_2026-08-07_CAPTURE.md:778` |
| 2026-08-15 | expiry | Generation spend policy EXPIRES: $100 AUD/day unconstrained reverts to unset | pip | 7, 1, 0 | `docs/art/PIXELLAB_OPERATIONS.md:43` |
| 2026-08-16 | handoff | Workshop 2 C5: four cross-repo bets scored, pdoom1 owes three RED run IDs | pdoom1-seat | 3, 1, 0 | `docs/calendar/COMMITMENTS.md:161` |
| 2026-08-20 | cadence | Thursday dev (the working half of the cadence) | pip | 0 | `docs/calendar/COMMITMENTS.md:172` |
...
| 2026-09-11 | cadence | Friday push -- an ordinary patch day, epoch-breaking changes only if player experience demands it | pip | 0 | `docs/calendar/COMMITMENTS.md:174` |
| 2026-09-11 | cadence | Rektango 17:30 -- the weekly anchor, a hard stop | pip | 0 | `docs/calendar/COMMITMENTS.md:176` |
...
| 2026-09-19 | review | Balance the desperation lever: play or sweep the 25.0 flat `doom.streams.action_desperation_absorb` against the compounding `payroll_coinflip` liability it buys, and either calibrate it or record that 25.0 survived contact | pip | 14, 3, 0 | `docs/game-design/DESPERATION_LEVER_PRICING.md:55` |
...
| 2026-10-01 | cadence | Thursday dev (the working half of the cadence) | pip | 0 | `docs/calendar/COMMITMENTS.md:172` |
| 2026-10-02 | cadence | Friday push -- an ordinary patch day, epoch-breaking changes only if player experience demands it | pip | 0 | `docs/calendar/COMMITMENTS.md:174` |
| 2026-10-02 | cadence | Rektango 17:30 -- the weekly anchor, a hard stop | pip | 0 | `docs/calendar/COMMITMENTS.md:176` |
| 2026-10-02 | release | Release train: v0.16 ships -- Sightings (prov.) | pip | 7, 1, 0 | `docs/ROADMAP.md (Monthly Themes table)` |
| 2026-10-08 | cadence | Thursday dev (the working half of the cadence) | pip | 0 | `docs/calendar/COMMITMENTS.md:172` |
| 2026-10-09 | cadence | Friday push -- an ordinary patch day, epoch-breaking changes only if player experience demands it | pip | 0 | `docs/calendar/COMMITMENTS.md:174` |
| 2026-10-09 | cadence | Rektango 17:30 -- the weekly anchor, a hard stop | pip | 0 | `docs/calendar/COMMITMENTS.md:176` |
| 2026-10-23 | expiry | gpt-image-1 retires; the art pipeline's default model needs migrating | pdoom1-seat | 7, 1, 0 | `docs/calendar/COMMITMENTS.md:188` |
| 2026-11-06 | release | Release train: v0.17 ships -- The World Shoots Back (prov.) | pip | 7, 1, 0 | `docs/ROADMAP.md (Monthly Themes table)` |
| 2026-12-04 | release | Release train: v0.18 ships -- (unnamed) | pip | 7, 1, 0 | `docs/ROADMAP.md (Monthly Themes table)` |
| 2026-12-19 | review | Read the 49 archived pygame-era dev-blog entries end to end and write the retrospective post: what the pygame era actually cost, what survived the port to Godot, and what the agent-written progress reports got wrong about their own importance | pip | 14, 3, 0 | `docs/DEV_BLOG_DECISION_2026-08-21.md:174` |
| 2027-07-27 | review | ADR-0018 render-only office doctrine: standing review | pdoom1-seat | 14, 3, 0 | `docs/calendar/COMMITMENTS.md:190` |
...
| Date | File | Line | Text |
|---|---|---|---|
| 2026-08-09 | `coordination#46` | 0 | D-seat checks in with G-seat: no memo has ever reached NEW-BORT, and #45's measured loop is exactly why that was invisible |
...
| 2026-08-09 | `docs/release-body-v0.14.0-CORRECTED.md` | 11 | **Corrected 2026-08-09.** As first published, this section named 14 issues in |
| 2026-08-09 | `docs/workshop-2/position.md` | 4 | postmortem. **Chair:** `pdoom-data`. **Written:** 2026-08-09, sealed before |
| 2026-08-09 | `docs/workshop-2/position.md` | 30 | 2026-08-09. Times are AEST (+10:00); where a UTC source is used the UTC value is |
| 2026-08-09 | `docs/workshop-2/position.md` | 649 | *Sealed by the `pdoom1` seat, 2026-08-09, before 11:00 AEST. Written against |
| 2026-08-09 | `pdoom1#1193` | 0 | #1137's event retiming made a simulated run ~38% more expensive -- is that the intended event density? |
| 2026-08-10 | `coordination#17` | 0 | pdoom1-website seat check-in, and a proposal: run a CONTENT workshop across the three sister repos |
| 2026-08-10 | `coordination#35` | 0 | Pip is out this evening through Rektango -- last synchronous window today. Post your asks ranked, or say you have none |
...
| 2026-08-11 | `docs/rulings/RULINGS.md` | 170 | Rulings with no `mechanism:`. Pip's doctrine (2026-08-11): what forces a |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 427 | - `tools/assets/backfill_provenance.py:38` -- ORIGIN VOCABULARY -- five values, ruled by Pip 2026-08-11 |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 429 | - `tools/assets/backfill_provenance.py:558` -- # The five values ruled by Pip 2026-08-11, as a constant rather than a literal |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 434 | - `tools/assets/check_provenance.py:4` -- Ruled by Pip 2026-08-11: the six unattributable assets are KEPT and recorded as |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 435 | - `tools/assets/check_provenance.py:439` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the " |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 438 | - `tools/assets/provenance_unknown_pin.json:2` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the unattributable assets, record them ho |
...
| 2026-08-11 | `docs/rulings/UNDECLARED_TRIAGE.md` | 279 | - ORIGIN VOCABULARY -- five values, ruled by Pip 2026-08-11 |
| 2026-08-11 | `docs/rulings/UNDECLARED_TRIAGE.md` | 283 | - # The five values ruled by Pip 2026-08-11, as a constant rather than a literal |
| 2026-08-11 | `docs/rulings/UNDECLARED_TRIAGE.md` | 293 | - Ruled by Pip 2026-08-11: the six unattributable assets are KEPT and recorded as |
| 2026-08-11 | `docs/rulings/UNDECLARED_TRIAGE.md` | 295 | - "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the " |
| 2026-08-11 | `docs/rulings/UNDECLARED_TRIAGE.md` | 426 | - "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the unattributable assets, record them honestly, and let a mechanism force the question l |
| 2026-08-11 | `scripts/generate_rulings.py` | 449 | "Rulings with no `mechanism:`. Pip's doctrine (2026-08-11): what forces a", |
...
| 2026-08-11 | `tools/assets/backfill_provenance.py` | 282 | # Pip 2026-08-15 after four assets pinned `unknown` since 2026-08-11 turned |
...
| 2026-08-12 | `docs/rulings/RULINGS.md` | 381 | - `godot/scripts/core/capacity.gd:5` -- ## Ruled 2026-08-12 (coordination/DESIGN_2026-08-12_interrupt-resolution-variants.md, |
...
| 2026-08-13 | `docs/VIDEO_SHOOT_2026-08-30.md` | 22 | first-time playtester on 2026-08-13. |
...
| 2026-08-13 | `docs/rulings/RULINGS.md` | 216 | - `docs/CONTENT_DISTRIBUTION_SYSTEM.md:10` -- > **SUPERSEDED, not merely "outdated in spirit", as of 2026-08-13.** Pip ruled |
...
| 2026-08-14 | `docs/deployment/GATE_AUDIT_2026-08-24.md` | 735 | \| `review-js-parses` \| the JS-in-Python gate from the 2026-08-14 dead-gallery day \| |
| 2026-08-14 | `docs/rituals/records/GATE_RECORD_2026-08-24_v0.14.3.md` | 51 | 2026-08-14. The one check in the ceremony that exercises the whole chain -- |
| 2026-08-14 | `docs/rituals/records/GATE_RECORD_2026-08-24_v0.14.3.md` | 137 | carried the rolled seed -- the league had been dark since 2026-08-14 for that |
| 2026-08-14 | `docs/rulings/RULINGS.md` | 400 | - `godot/tests/unit/simulation/test_events.gd:50` -- ## THE RATCHET WAS DELIBERATELY LOOSENED -- 2026-08-14, ruled by Pip, for content velocity. |
...
| 2026-08-15 | `docs/art/HARVEST_PASS_PROPOSAL.md` | 86 | ## The diagnosis (Pip, 2026-08-15) |
...
| 2026-08-15 | `docs/art/MOTIF_AND_WATERMARK_PROTOCOL.md` | 51 | ## Measured, 2026-08-15 -- the harvest axis has never been used |
| 2026-08-15 | `docs/art/MOTIF_AND_WATERMARK_PROTOCOL.md` | 108 | on 2026-08-15; the AI terms were added in the 2024 Q3 release. |
...
| 2026-08-15 | `docs/rulings/RULINGS.md` | 58 | \| 2026-08-15 \| Tier W (website disclosure) ships first and standalone; Tier G (in-game motifs and epoch marks) stays ruled-but-unbuilt \| `docs/art/MOT |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 59 | \| 2026-08-15 \| an embedded CA-signed C2PA credential outranks every provenance heuristic; it becomes evidence tier S and resolves an asset out of the  |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 68 | \| 2026-08-15 \| flaw:<thing> joins the harvest vocabulary as the negative counterpart to element:, because the sweeps are mostly negative and prose can |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 84 | \| 2026-08-15 \| the ruling road is cross-repo from day one, federated: each repo scans itself and emits rulings.json, an aggregator reads them, nothing |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 85 | \| 2026-08-15 \| naming a mechanism is OPTIONAL on a ruling, and the generated index reports which rulings have none \| `scripts/generate_rulings.py` \| ` |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 214 | - `CLAUDE.md:254` -- `UNDECLARED`, never dropped. **Cross-repo by design** (ruled 2026-08-15): |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 374 | - `godot/data/asset_provenance.json:5132` -- "why": "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and is the only evidence th |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 425 | - `tools/art_review/serve_review.py:205` -- "to element: -- ruled by Pip 2026-08-15 because the sweeps are mostly " |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 428 | - `tools/assets/backfill_provenance.py:479` -- "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and " |
...
| 2026-08-15 | `docs/rulings/RULINGS_CONVENTION.md` | 86 | RULING: 2026-08-15 -- masters are written verbatim, never re-encoded -- flavour: art-provenance -- mechanism: tools/assets/check_credentials.py |
| 2026-08-15 | `docs/rulings/RULINGS_CONVENTION.md` | 104 | 2026-08-15: it taxes every capture, and the predictable result is rulings that |
| 2026-08-15 | `docs/rulings/RULINGS_CONVENTION.md` | 139 | Ruled by Pip 2026-08-15: the road is cross-repo from day one. |
| 2026-08-15 | `docs/rulings/RULINGS_CONVENTION.md` | 164 | "id": "pdoom1:2026-08-15:1a2b3c4d", |
| 2026-08-15 | `docs/rulings/RULINGS_CONVENTION.md` | 165 | "date": "2026-08-15", |
| 2026-08-15 | `docs/rulings/UNDECLARED_TRIAGE.md` | 275 | - "to element: -- ruled by Pip 2026-08-15 because the sweeps are mostly " |
| 2026-08-15 | `docs/rulings/UNDECLARED_TRIAGE.md` | 281 | - "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and " |
| 2026-08-15 | `docs/rulings/UNDECLARED_TRIAGE.md` | 412 | - "why": "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and is the only evidence that survives a file moving between repos. Ap |
...
| 2026-08-15 | `tools/assets/backfill_provenance.py` | 282 | # Pip 2026-08-15 after four assets pinned `unknown` since 2026-08-11 turned |
| 2026-08-15 | `tools/assets/backfill_provenance.py` | 413 | Measured 2026-08-15: a full re-run on this machine would move 245 records |
| 2026-08-15 | `tools/assets/backfill_provenance.py` | 479 | "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and " |
...
| 2026-08-17 | `docs/rulings/RULINGS.md` | 86 | \| 2026-08-17 \| published figures live in tooling, not prose: the line item is the atom and every rendering is a projection \| `tools/render_budget.py - |
| 2026-08-17 | `docs/rulings/RULINGS.md` | 166 | \| 2026-08-17 \| the game has ONE font-size lever (theme/base_theme.tres default_font_size, registered as the project theme) and a raw size override is  |
...
| 2026-08-17 | `tools/transcribe.py` | 215 | # The figure printed here was 0.5-1.5x realtime until 2026-08-17, which was a |
...
| 2026-08-19 | `docs/rulings/RULINGS.md` | 60 | \| 2026-08-19 \| New-Bort is the working machine and hosts new archives and images; the generated masters are NOT transferred to it but coordinated on a |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 61 | \| 2026-08-19 \| every asset record names its author as well as its origin, with a named agent only where a source already in the repo names one and `un |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 62 | \| 2026-08-19 \| the provenance guard compares against the git blob, not the working tree, and runs in pre-commit and CI; a guard wired to nothing is a  |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 375 | - `godot/data/asset_provenance.json:5138` -- "why": "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this manifest answered only WH |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 376 | - `godot/data/asset_provenance.json:5150` -- "why": "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this manifest answered only WH |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 430 | - `tools/assets/backfill_provenance.py:673` -- "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this " |
...
| 2026-08-19 | `tools/assets/backfill_provenance.py` | 555 | # RULING: 2026-08-19 -- every asset record names its author as well as its origin, with a named agent only where a source already in the repo names on |
| 2026-08-19 | `tools/assets/backfill_provenance.py` | 574 | "who committed the file. Added 2026-08-19 (D2) because a human contributor " |
| 2026-08-19 | `tools/assets/backfill_provenance.py` | 673 | "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this " |
...
| 2026-08-20 | `docs/rulings/RULINGS.md` | 209 | - `.github/workflows/guards.yml:3` -- # WHY THIS FILE EXISTS (issue #1265, ruled by Pip 2026-08-20) |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 242 | - `docs/art/A4_COLLAPSE_2026-08-20.md:3` -- **2026-08-20, `pdoom1` seat on New-Bort.** Ruled by Pip: canonicalise on the write |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 415 | - `tools/art_review/ORPHANS_2026-08-15.md:65` -- **A4: RULED 2026-08-20 and DONE.** Canonicalise on the write path and collapse the |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 419 | - `tools/art_review/collapse_px_keys.py:4` -- ORPHANS A4. Ruled by Pip 2026-08-20: canonicalise on the write path AND collapse |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 442 | - `tools/check_guard_parity.py:6` -- WHY THIS EXISTS (issue #1265, ruled by Pip 2026-08-20) |
...
| 2026-08-21 | `docs/DEV_BLOG_DECISION_2026-08-21.md` | 3 | Written 2026-08-21 for Pip. **One decision is needed; everything else follows |
| 2026-08-21 | `docs/DEV_BLOG_DECISION_2026-08-21.md` | 92 | Pip, 2026-08-21: |
| 2026-08-21 | `docs/DEV_BLOG_DECISION_2026-08-21.md` | 153 | ## DECIDED, 2026-08-21 |
| 2026-08-21 | `docs/LEDGER_ROW_PROTOCOL_2026-08-21.md` | 1 | # Ledger row: protocol, etiquette, procedure -- as at 2026-08-21 |
| 2026-08-21 | `docs/LEDGER_ROW_PROTOCOL_2026-08-21.md` | 158 | 2026-08-21**, and name the artifact for each. Do not backdate the `blessed` |
| 2026-08-21 | `docs/LEDGER_ROW_PROTOCOL_2026-08-21.md` | 174 | `api.pdoom1.com`. Diagnosed 2026-08-21: DNS resolves to `208.113.200.215`, but |
...
| 2026-08-21 | `docs/rulings/RULINGS.md` | 409 | - `scripts/generate_rulings.py:164` -- # CONSOLIDATION, ruled by Pip 2026-08-21. |
...
| 2026-08-21 | `scripts/check_no_emoji.py` | 186 | Measured 2026-08-21 (#1163): godot/data/historical_events.json carried |
| 2026-08-21 | `scripts/check_no_emoji.py` | 249 | # copied from godot/data/historical_events.json as it stood on 2026-08-21: |
...
| 2026-08-21 | `tools/check_ladder_bump.py` | 366 | THE HOLE THIS CLOSES (measured 2026-08-21). Direction 1 below accepts any |
| 2026-08-21 | `tools/check_ladder_bump.py` | 441 | # is a DEBT, and until 2026-08-21 it printed identically to `none`. |
| 2026-08-21 | `tools/generate_release_horizon.py` | 27 | L5  2026-08-21  38528c22  v0.14.2   <- PATCH bump, ladder cut |
...
| 2026-08-22 | `docs/rulings/RULINGS.md` | 74 | \| 2026-08-22 \| a check that fails 100% of the time is not a check; chronic red trains the team to ignore red, so a permanently-failing gate must be ei |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 116 | \| 2026-08-22 \| a mechanic that charges the player and does nothing observable gets an unsubtle placeholder consequence NOW rather than waiting for a b |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 308 | - `docs/game-design/DESPERATION_LEVER_PRICING.md:3` -- **Ruled by Pip, 2026-08-22:** *"we need to give the mechanical inertness a definite |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 390 | - `godot/scripts/core/researcher.gd:190` -- # Ruled by Pip 2026-08-22 (#1247): "real STAFF, but they might not eg produce |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 402 | - `godot/tests/unit/test_compute_engineers_are_staff.gd:12` -- ## Ruled by Pip 2026-08-22: "real STAFF, but they might not eg produce as much |
| 2026-08-22 | `tools/check_chronic_red.py` | 97 | "docs/mechanics/** -- so no qualifying PR has run since 2026-08-22 and the " |
| 2026-08-22 | `tools/check_chronic_red.py` | 390 | "docs-sync.yml:push": [("success", "2026-08-22")] * 4, |
| 2026-08-22 | `tools/check_chronic_red.py` | 391 | "docs-sync.yml:pull_request": [("failure", "2026-08-22")] * 39, |
| 2026-08-22 | `tools/check_chronic_red.py` | 500 | "docs-sync.yml:pull_request": [("failure", "2026-08-22")] * 39, |
...
| 2026-08-23 | `docs/VIDEO_SHOOT_2026-08-30.md` | 8 | claims in it (`docs/archive/2026-08-23-architecture-funders/`), and a video is |
...
| 2026-08-23 | `docs/game-design/decisions/ADR-0020-machine-actor-identity.md` | 4 | - **Date:** 2026-08-23 |
| 2026-08-23 | `docs/game-design/decisions/ADR-0020-machine-actor-identity.md` | 6 | - **Session:** D4, approved 2026-08-23 via the coordination seat with the constraint *"actually create things without me, but then don't release them. |
| 2026-08-23 | `docs/game-design/decisions/ADR-0020-machine-actor-identity.md` | 12 | Pip, reading a printed pack, 2026-08-23: |
| 2026-08-23 | `docs/game-design/decisions/ADR-0020-machine-actor-identity.md` | 36 | So a reader of any repo's history sees one prolific human. On 2026-08-23 alone |
| 2026-08-23 | `docs/game-design/decisions/ADR-0020-machine-actor-identity.md` | 102 | 2026-08-23, agent-driven, under Pip's admin rights. Under this ADR the agent |
| 2026-08-23 | `docs/game-design/decisions/ADR-0020-machine-actor-identity.md` | 206 | - **The naming is provisional on purpose.** Pip, 2026-08-23: *"we'll call it |
| 2026-08-23 | `docs/game-design/decisions/README.md` | 33 | \| [ADR-0020](ADR-0020-machine-actor-identity.md) \| Machine actor identity: a bot acts under its own name, or the attribution record is fiction \| PROPO |
...
| 2026-08-23 | `docs/rulings/RULINGS.md` | 52 | \| 2026-08-23 \| ADR-0020 -- Machine actor identity: a bot acts under its own name, or the attribution record is fiction \| -- none -- \| `docs/game-desig |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 101 | \| 2026-08-23 \| ~~ladder debt is paid when it is incurred, not deferred to build time, so a fresh epoch never inherits a forked board key~~ (superseded |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 101 | \| 2026-08-23 \| ~~ladder debt is paid when it is incurred, not deferred to build time, so a fresh epoch never inherits a forked board key~~ (superseded |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 102 | \| 2026-08-23 \| ladder debt is DECLARED when incurred and PAID at the release that ships it; deferring is legal, forgetting is not, and the epoch must  |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 122 | \| 2026-08-23 \| player feedback routes to the PUBLIC issue tracker and is triaged and summarised before the developer reads it; it never lands in a per |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 158 | \| 2026-08-23 \| silent failures are a named defect class and the counter is instrumentation, never vigilance; a failure representable in its own succes |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 200 | - `pdoom1:2026-08-23:278981bd` -- ADR-0020 -- Machine actor identity: a bot acts under its own name, or the attribution record is fiction (`docs/game- |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 443 | - `tools/check_release_ledger.py:30` -- This is the ruled ``manufactured confidence`` shape (Pip, 2026-08-23 16:42): |
| 2026-08-23 | `scripts/generate_release_manifest.py` | 114 | 2026-08-23 "manufactured confidence" ruling, a value meaning "I could not |
| 2026-08-23 | `scripts/generate_release_metadata.py` | 166 | RULING 2026-08-23 (Pip, "manufactured confidence"): a value meaning "I could |
...
| 2026-08-23 | `tools/generate_release_horizon.py` | 28 | L6  2026-08-23  38c5951e  (no version move) |
...
| 2026-08-24 | `docs/CI_FOSSILS_2026-08-30.md` | 100 | 04:23 UTC cron went green for the first time since 2026-08-24. |
...
| 2026-08-24 | `docs/VIDEO_SHOOT_2026-08-30.md` | 148 | 285 seconds, submitted 2026-08-24 from v0.14.3. |
...
| 2026-08-24 | `docs/deployment/GATE_AUDIT_2026-08-24.md` | 951 | RULING: 2026-08-24 -- a workflow that writes anything must declare `permissions:`, because this repo's default workflow token is read-only and a write |
| 2026-08-24 | `docs/deployment/RELEASE_FLOW_MAP_2026-08-24.md` | 1 | # Release and CI flow map -- 2026-08-24 |
| 2026-08-24 | `docs/deployment/RELEASE_FLOW_MAP_2026-08-24.md` | 566 | RULING: 2026-08-24 -- a release must be verified before it is published, not after: verify-release-urls runs downstream of create-github-release, so o |
| 2026-08-24 | `docs/deployment/RELEASE_FLOW_MAP_2026-08-24.md` | 568 | RULING: 2026-08-24 -- two workflows firing on the same event with no dependency between them are not parallel, they are racing to a verdict nobody joi |
...
| 2026-08-24 | `docs/game-design/DESIGN_2026-08-24_diegetic-opening.md` | 4 | > 2026-08-24 for Pip from voice-memo atoms M24-002 .. M24-009 (memo `084241`), which are |
| 2026-08-24 | `docs/game-design/DESIGN_2026-08-24_diegetic-opening.md` | 16 | > RULING: 2026-08-24 -- the diegetic-opening redesign (M24-002..009) must not be ladder- or epoch-breaking -- flavour: ladder-epochs -- mechanism: `to |
...
| 2026-08-24 | `docs/rituals/records/GATE_RECORD_2026-08-24_v0.14.3.md` | 20 | morning of 2026-08-24, during ISO week 35. Pip ruled that the seed names the ISO |
| 2026-08-24 | `docs/rituals/records/GATE_RECORD_2026-08-24_v0.14.3.md` | 30 | ## [Gate 6: BOARD OPENS] -- PASSED 2026-08-24, time DISPUTED (see below) |
| 2026-08-24 | `docs/rituals/records/GATE_RECORD_2026-08-24_v0.14.3.md` | 63 | Spoken by **Pip Foweraker**. The words reached this seat at 2026-08-24 |
| 2026-08-24 | `docs/rituals/records/GATE_RECORD_2026-08-24_v0.14.3.md` | 82 | text and `date` returned `2026-08-24 20:59:06 AUSEST` when it did. In the |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 75 | \| 2026-08-24 \| a command's exit status must be read from the command, never through a pipe: $? after a pipeline is the RIGHTMOST command's status, so  |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 76 | \| 2026-08-24 \| a gate's verdict must be traced to a consumer before it is called a gate: a red that blocks no merge, gates no job, and reaches no huma |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 77 | \| 2026-08-24 \| a workflow that writes anything must declare `permissions:`, because this repo's default workflow token is read-only and a write attemp |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 78 | \| 2026-08-24 \| two workflows firing on the same event with no dependency between them are not parallel, they are racing to a verdict nobody joins: on  |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 92 | \| 2026-08-24 \| an environment no workflow references is either clutter or a lie, and which one depends entirely on what it is called; a safety-vocabul |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 93 | \| 2026-08-24 \| a guard wired only to pre-commit is not installed; every local hook must either run in a workflow or carry a declared waiver naming wha |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 103 | \| 2026-08-24 \| the diegetic-opening redesign (M24-002..009) must not be ladder- or epoch-breaking \| ``tools/check_ladder_bump.py`` \| `docs/game-design |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 109 | \| 2026-08-24 \| the featured seed names the ISO week the league opens in, so a league that slips is renamed to the week it actually runs and the slip i |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 110 | \| 2026-08-24 \| the featured seed names the ISO week the league opens in \| `godot/tests/unit/test_iso_week_seed.gd` \| `godot/tests/unit/test_iso_week_s |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 128 | \| 2026-08-24 \| a published release artifact states a platform shipped only by enumerating an asset that exists, never by a naming convention or a hard |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 134 | \| 2026-08-24 \| every value version.txt has ever held must have a matching git tag, or a declared exemption; a bump with no tag is a defect the machine |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 135 | \| 2026-08-24 \| a minor version bump ALWAYS cuts the ladder, and the ladder MAY ALSO cut mid-version whenever gameplay forks; therefore ladder epochs > |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 141 | \| 2026-08-24 \| a release must be verified before it is published, not after: verify-release-urls runs downstream of create-github-release, so on v0.14 |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 159 | \| 2026-08-24 \| a best-effort platform build that fails must be TRACKED, not merely warned about: the release still publishes for the platforms that bu |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 160 | \| 2026-08-24 \| a player-facing surface must not collapse distinct failures into one reassuring sentence: each cause gets its own words, its own conseq |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 366 | - `docs/releases/RELEASE_LINKING_TO_0.20.md:175` -- Under the atomise protocol clause 3 (ruled 2026-08-24: *"do not build an atom |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 367 | - `docs/rituals/records/GATE_RECORD_2026-08-24_v0.14.3.md:20` -- morning of 2026-08-24, during ISO week 35. Pip ruled that the seed names the ISO |
...
| 2026-08-24 | `scripts/check_platform_builds.py` | 6 | Why this exists (v0.14.3, 2026-08-24) |
| 2026-08-24 | `scripts/check_platform_builds.py` | 227 | the workflow. RULING 2026-08-24 (flavour ci-gates) says a command's exit |
| 2026-08-24 | `scripts/generate_release_manifest.py` | 43 | literal until 2026-08-24). Lists only platforms whose |
| 2026-08-24 | `scripts/generate_release_manifest.py` | 99 | THE BUG THIS REPLACES (v0.14.3, 2026-08-24): `platforms` was the literal |
| 2026-08-24 | `scripts/generate_release_manifest.py` | 238 | This was the THIRD copy of the same defect (2026-08-24): the excerpt reached a |
| 2026-08-24 | `scripts/generate_release_metadata.py` | 64 | # before 2026-08-24 and call them what they are. Never emitted again. |
| 2026-08-24 | `scripts/generate_release_metadata.py` | 91 | # RULING: 2026-08-24 -- a published release artifact states a platform shipped only by enumerating an asset that exists, never by a naming convention  |
| 2026-08-24 | `scripts/generate_release_metadata.py` | 125 | # v0.14.3 (2026-08-24) was the second shape, and the convention was RIGHT this |
| 2026-08-24 | `scripts/generate_release_metadata.py` | 374 | # on every entry of a pre-2026-08-24 index. That is the same call |
| 2026-08-24 | `scripts/generate_release_metadata.py` | 462 | Used by --check to name the defect in an index generated before 2026-08-24, |
...
| 2026-08-24 | `tools/generate_release_horizon.py` | 75 | `pdoom.release-horizon/0.1`). Under the atomise protocol clause 3 (2026-08-24: |
...
| 2026-08-29 | `docs/CI_FOSSILS_2026-08-30.md` | 15 | 2026-08-29 (#1336), after its first version declared three of them as chronic -- |
| 2026-08-29 | `docs/CI_FOSSILS_2026-08-30.md` | 99 | - `release-ledger.yml:schedule`, which cleared itself on 2026-08-29 when its |
| 2026-08-29 | `docs/RELEASE_NOTES_GUARD.md` | 56 | ### The PR-time row was added on 2026-08-29, and here is what it cost to learn |
| 2026-08-29 | `docs/rulings/RULINGS.md` | 74 | \| 2026-08-22 \| a check that fails 100% of the time is not a check; chronic red trains the team to ignore red, so a permanently-failing gate must be ei |
| 2026-08-29 | `docs/rulings/RULINGS.md` | 94 | \| 2026-08-29 \| a workflow red for three consecutive runs of the same trigger must be fixed or declared, because an undeclared chronic red makes every  |
...
| 2026-08-29 | `tools/check_chronic_red.py` | 409 | fake = {"invented-workflow.yml:push": [("failure", "2026-08-29")] * 5} |
| 2026-08-29 | `tools/check_chronic_red.py` | 417 | chronic(census({"x.yml:push": [("failure", "2026-08-29")] * 2})) == [], |
| 2026-08-29 | `tools/check_chronic_red.py` | 421 | healthy = {k: [("success", "2026-08-29")] * 4 for k in DECLARED} |
| 2026-08-29 | `tools/check_chronic_red.py` | 435 | # FOSSILS (added 2026-08-29, after this tool's first live run declared three). |
| 2026-08-29 | `tools/check_chronic_red.py` | 448 | still_live = census({"live.yml:push": [("failure", "2026-08-29")] * 30}) |
| 2026-08-29 | `tools/check_chronic_red.py` | 485 | # Listing them was the 2026-08-29 behaviour and it was not enough: a fossil |
...
| 2026-08-30 | `docs/CI_FOSSILS_2026-08-30.md` | 3 | Written 2026-08-30, immediately before the deletion it records, so that removing |
...
| 2026-08-30 | `docs/VIDEO_SHOOT_2026-08-30.md` | 127 | Say these. Each one has a command that returns it, run today, 2026-08-30. |
...
| 2026-08-30 | `docs/rulings/RULINGS.md` | 441 | - `tools/check_chronic_red.py:579` -- print("  Ruled 2026-08-30: a fossil is REMOVED, never declared. A declaration for") |
| 2026-08-30 | `tools/check_chronic_red.py` | 250 | Fossils count as failures as of 2026-08-30 (ruled by Pip; see |
| 2026-08-30 | `tools/check_chronic_red.py` | 484 | # FOSSILS NOW FAIL (ruled by Pip 2026-08-30, docs/CI_FOSSILS_2026-08-30.md). |
| 2026-08-30 | `tools/check_chronic_red.py` | 499 | "live.yml:push": [("success", "2026-08-30")] * 5, |
| 2026-08-30 | `tools/check_chronic_red.py` | 579 | print("  Ruled 2026-08-30: a fossil is REMOVED, never declared. A declaration for") |
| 2026-08-31 | `docs/rulings/RULINGS.md` | 389 | - `godot/scripts/core/researcher.gd:150` -- # SEAM (ruled 2026-07-27, review-by 2026-08-31): AUDITS ground-truth reported vs actual. |
| 2026-08-31 | `docs/rulings/RULINGS.md` | 394 | - `godot/scripts/core/turn_manager.gd:313` -- SEAM (ruled 2026-07-27, review-by 2026-08-31): AUDITS ground-truth reported vs actual. |
...
| 2026-09-09 | `docs/VIDEO_SHOOT_2026-08-30.md` | 219 | **What is the ask at the end?** The Manifund campaign closes **2026-09-09**, nine |
...
| 2027-01-01 | `tools/generate_release_horizon.py` | 68 | v0.19 is scheduled for Friday 2027-01-01, so this is not a hypothetical. The |
| 2027-01-01 | `tools/generate_release_horizon.py` | 368 | "the calendar year. Friday 2027-01-01 is in ISO **week 53 of 2026**, so", |
| 2027-01-01 | `tools/generate_release_horizon.py` | 664 | print("[self-test] FAIL: the ISO-year guard is not live -- 2027-01-01 emitted %s" % naive) |
| 2027-01-01 | `tools/generate_release_horizon.py` | 678 | "            ISO-year guard live: 2027-01-01 -> %s (naive: %s)." |
...
| 2027-07-27 | `docs/game-design/DESIGN_2026-08-24_diegetic-opening.md` | 628 | is ruled out today."* The doctrine has a **review clause dated 2027-07-27** and that review is |
| 2027-07-27 | `docs/rulings/RULINGS.md` | 302 | - `docs/game-design/DESIGN_2026-08-24_diegetic-opening.md:628` -- is ruled out today."* The doctrine has a **review clause dated 2027-07-27** and that |
