...
| 2026-08-11 | `docs/rulings/RULINGS.md` | 145 | Rulings with no `mechanism:`. Pip's doctrine (2026-08-11): what forces a |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 389 | - `tools/assets/backfill_provenance.py:38` -- ORIGIN VOCABULARY -- five values, ruled by Pip 2026-08-11 |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 391 | - `tools/assets/backfill_provenance.py:558` -- # The five values ruled by Pip 2026-08-11, as a constant rather than a literal |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 396 | - `tools/assets/check_provenance.py:4` -- Ruled by Pip 2026-08-11: the six unattributable assets are KEPT and recorded as |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 397 | - `tools/assets/check_provenance.py:439` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the " |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 400 | - `tools/assets/provenance_unknown_pin.json:2` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the unattributable assets, record them ho |
...
| 2026-08-13 | `docs/rulings/RULINGS.md` | 189 | - `docs/CONTENT_DISTRIBUTION_SYSTEM.md:10` -- > **SUPERSEDED, not merely "outdated in spirit", as of 2026-08-13.** Pip ruled |
...
| 2026-08-15 | `docs/rulings/RULINGS.md` | 187 | - `CLAUDE.md:254` -- `UNDECLARED`, never dropped. **Cross-repo by design** (ruled 2026-08-15): |
...
| 2026-08-15 | `docs/rulings/RULINGS.md` | 387 | - `tools/art_review/serve_review.py:205` -- "to element: -- ruled by Pip 2026-08-15 because the sweeps are mostly " |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 390 | - `tools/assets/backfill_provenance.py:479` -- "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and " |
...
| 2026-08-17 | `docs/rulings/RULINGS.md` | 141 | \| 2026-08-17 \| the game has ONE font-size lever (theme/base_theme.tres default_font_size, registered as the project theme) and a raw size override is  |
...
| 2026-08-19 | `docs/rulings/RULINGS.md` | 392 | - `tools/assets/backfill_provenance.py:673` -- "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this " |
...
| 2026-08-20 | `docs/rulings/RULINGS.md` | 377 | - `tools/art_review/ORPHANS_2026-08-15.md:65` -- **A4: RULED 2026-08-20 and DONE.** Canonicalise on the write path and collapse the |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 381 | - `tools/art_review/collapse_px_keys.py:4` -- ORPHANS A4. Ruled by Pip 2026-08-20: canonicalise on the write path AND collapse |
...
| 2026-08-21 | `docs/rulings/RULINGS.md` | 371 | - `scripts/generate_rulings.py:164` -- # CONSOLIDATION, ruled by Pip 2026-08-21. |
...
| 2026-08-22 | `docs/rulings/RULINGS.md` | 100 | \| 2026-08-22 \| a mechanic that charges the player and does nothing observable gets an unsubtle placeholder consequence NOW rather than waiting for a b |
...
| 2026-08-23 | `docs/rulings/RULINGS.md` | 135 | \| 2026-08-23 \| silent failures are a named defect class and the counter is instrumentation, never vigilance; a failure representable in its own succes |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 401 | - `tools/check_release_ledger.py:30` -- This is the ruled ``manufactured confidence`` shape (Pip, 2026-08-23 16:42): |
| 2026-08-23 | `scripts/generate_release_manifest.py` | 113 | 2026-08-23 "manufactured confidence" ruling, a value meaning "I could not |
| 2026-08-23 | `scripts/generate_release_metadata.py` | 119 | RULING 2026-08-23 (Pip, "manufactured confidence"): a value meaning "I could |
...
| 2026-08-24 | `docs/rulings/RULINGS.md` | 112 | \| 2026-08-24 \| a published release artifact states a platform shipped only by enumerating an asset that exists, never by a naming convention or a hard |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 118 | \| 2026-08-24 \| every value version.txt has ever held must have a matching git tag, or a declared exemption; a bump with no tag is a defect the machine |
...
| 2026-08-24 | `scripts/generate_release_manifest.py` | 98 | THE BUG THIS REPLACES (v0.14.3, 2026-08-24): `platforms` was the literal |
| 2026-08-24 | `scripts/generate_release_metadata.py` | 63 | # RULING: 2026-08-24 -- a published release artifact states a platform shipped only by enumerating an asset that exists, never by a naming convention  |
| 2026-08-24 | `scripts/generate_release_metadata.py` | 65 | # v0.14.3 (2026-08-24) was the second shape, and the convention was RIGHT this |
