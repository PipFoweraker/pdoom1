...
| 2026-08-22 | `docs/rulings/RULINGS.md` | 73 | \| 2026-08-22 \| a check that fails 100% of the time is not a check; chronic red trains the team to ignore red, so a permanently-failing gate must be ei |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 93 | \| 2026-08-22 \| a mechanic that charges the player and does nothing observable gets an unsubtle placeholder consequence NOW rather than waiting for a b |
...
| 2026-08-23 | `docs/rulings/RULINGS.md` | 99 | \| 2026-08-23 \| player feedback routes to the PUBLIC issue tracker and is triaged and summarised before the developer reads it; it never lands in a per |
