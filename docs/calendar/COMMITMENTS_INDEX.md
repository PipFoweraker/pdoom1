...
**53 declared, 4 release-train, 163 UNPARSED, 0 malformed.**
...
| 2026-08-10 | task | Book the half-day audit-mechanics workshop, target window opens | pip | 2, 0 | `docs/rulings/RULINGS.md:213` |
...
| 2026-08-11 | `docs/rulings/RULINGS.md` | 127 | Rulings with no `mechanism:`. Pip's doctrine (2026-08-11): what forces a |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 368 | - `tools/assets/backfill_provenance.py:38` -- ORIGIN VOCABULARY -- five values, ruled by Pip 2026-08-11 |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 370 | - `tools/assets/backfill_provenance.py:558` -- # The five values ruled by Pip 2026-08-11, as a constant rather than a literal |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 375 | - `tools/assets/check_provenance.py:4` -- Ruled by Pip 2026-08-11: the six unattributable assets are KEPT and recorded as |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 376 | - `tools/assets/check_provenance.py:439` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the " |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 379 | - `tools/assets/provenance_unknown_pin.json:2` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the unattributable assets, record them ho |
...
| 2026-08-12 | `docs/rulings/RULINGS.md` | 324 | - `godot/scripts/core/capacity.gd:5` -- ## Ruled 2026-08-12 (coordination/DESIGN_2026-08-12_interrupt-resolution-variants.md, |
...
| 2026-08-13 | `docs/rulings/RULINGS.md` | 172 | - `docs/CONTENT_DISTRIBUTION_SYSTEM.md:10` -- > **SUPERSEDED, not merely "outdated in spirit", as of 2026-08-13.** Pip ruled |
...
| 2026-08-14 | `docs/rulings/RULINGS.md` | 343 | - `godot/tests/unit/simulation/test_events.gd:50` -- ## THE RATCHET WAS DELIBERATELY LOOSENED -- 2026-08-14, ruled by Pip, for content velocity. |
...
| 2026-08-15 | `docs/rulings/RULINGS.md` | 170 | - `CLAUDE.md:254` -- `UNDECLARED`, never dropped. **Cross-repo by design** (ruled 2026-08-15): |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 317 | - `godot/data/asset_provenance.json:5132` -- "why": "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and is the only evidence th |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 366 | - `tools/art_review/serve_review.py:205` -- "to element: -- ruled by Pip 2026-08-15 because the sweeps are mostly " |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 369 | - `tools/assets/backfill_provenance.py:479` -- "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and " |
...
| 2026-08-17 | `docs/rulings/RULINGS.md` | 123 | \| 2026-08-17 \| the game has ONE font-size lever (theme/base_theme.tres default_font_size, registered as the project theme) and a raw size override is  |
...
| 2026-08-19 | `docs/rulings/RULINGS.md` | 318 | - `godot/data/asset_provenance.json:5138` -- "why": "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this manifest answered only WH |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 319 | - `godot/data/asset_provenance.json:5150` -- "why": "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this manifest answered only WH |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 371 | - `tools/assets/backfill_provenance.py:673` -- "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this " |
...
| 2026-08-20 | `docs/rulings/RULINGS.md` | 165 | - `.github/workflows/guards.yml:3` -- # WHY THIS FILE EXISTS (issue #1265, ruled by Pip 2026-08-20) |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 196 | - `docs/art/A4_COLLAPSE_2026-08-20.md:3` -- **2026-08-20, `pdoom1` seat on New-Bort.** Ruled by Pip: canonicalise on the write |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 356 | - `tools/art_review/ORPHANS_2026-08-15.md:65` -- **A4: RULED 2026-08-20 and DONE.** Canonicalise on the write path and collapse the |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 360 | - `tools/art_review/collapse_px_keys.py:4` -- ORPHANS A4. Ruled by Pip 2026-08-20: canonicalise on the write path AND collapse |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 380 | - `tools/check_guard_parity.py:6` -- WHY THIS EXISTS (issue #1265, ruled by Pip 2026-08-20) |
...
| 2026-08-21 | `docs/rulings/RULINGS.md` | 350 | - `scripts/generate_rulings.py:164` -- # CONSOLIDATION, ruled by Pip 2026-08-21. |
...
| 2026-08-22 | `docs/rulings/RULINGS.md` | 94 | \| 2026-08-22 \| a mechanic that charges the player and does nothing observable gets an unsubtle placeholder consequence NOW rather than waiting for a b |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 254 | - `docs/game-design/DESPERATION_LEVER_PRICING.md:3` -- **Ruled by Pip, 2026-08-22:** *"we need to give the mechanical inertness a definite |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 333 | - `godot/scripts/core/researcher.gd:190` -- # Ruled by Pip 2026-08-22 (#1247): "real STAFF, but they might not eg produce |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 345 | - `godot/tests/unit/test_compute_engineers_are_staff.gd:12` -- ## Ruled by Pip 2026-08-22: "real STAFF, but they might not eg produce as much |
...
| 2026-08-23 | `docs/rulings/RULINGS.md` | 88 | \| 2026-08-23 \| ladder debt is paid when it is incurred, not deferred to build time, so a fresh epoch never inherits a forked board key \| `tools/check_ |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 100 | \| 2026-08-23 \| player feedback routes to the PUBLIC issue tracker and is triaged and summarised before the developer reads it; it never lands in a per |
| 2026-08-23 | `docs/rulings/RULINGS.md` | 117 | \| 2026-08-23 \| silent failures are a named defect class and the counter is instrumentation, never vigilance; a failure representable in its own succes |
...
| 2026-08-24 | `docs/rulings/RULINGS.md` | 81 | \| 2026-08-24 \| an environment no workflow references is either clutter or a lie, and which one depends entirely on what it is called; a safety-vocabul |
| 2026-08-24 | `docs/rulings/RULINGS.md` | 82 | \| 2026-08-24 \| a guard wired only to pre-commit is not installed; every local hook must either run in a workflow or carry a declared waiver naming wha |
...
| 2026-08-31 | `docs/rulings/RULINGS.md` | 332 | - `godot/scripts/core/researcher.gd:150` -- # SEAM (ruled 2026-07-27, review-by 2026-08-31): AUDITS ground-truth reported vs actual. |
| 2026-08-31 | `docs/rulings/RULINGS.md` | 337 | - `godot/scripts/core/turn_manager.gd:313` -- SEAM (ruled 2026-07-27, review-by 2026-08-31): AUDITS ground-truth reported vs actual. |
