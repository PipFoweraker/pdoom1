...
| 2026-08-10 | task | Book the half-day audit-mechanics workshop, target window opens | pip | 2, 0 | `docs/rulings/RULINGS.md:187` |
...
| 2026-08-11 | `docs/rulings/RULINGS.md` | 102 | Rulings with no `mechanism:`. Pip's doctrine (2026-08-11): what forces a |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 342 | - `tools/assets/backfill_provenance.py:38` -- ORIGIN VOCABULARY -- five values, ruled by Pip 2026-08-11 |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 344 | - `tools/assets/backfill_provenance.py:558` -- # The five values ruled by Pip 2026-08-11, as a constant rather than a literal |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 349 | - `tools/assets/check_provenance.py:4` -- Ruled by Pip 2026-08-11: the six unattributable assets are KEPT and recorded as |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 350 | - `tools/assets/check_provenance.py:439` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the " |
| 2026-08-11 | `docs/rulings/RULINGS.md` | 353 | - `tools/assets/provenance_unknown_pin.json:2` -- "_why": "Pinned unknown set. Ruled by Pip 2026-08-11: keep the unattributable assets, record them ho |
...
| 2026-08-12 | `docs/rulings/RULINGS.md` | 298 | - `godot/scripts/core/capacity.gd:5` -- ## Ruled 2026-08-12 (coordination/DESIGN_2026-08-12_interrupt-resolution-variants.md, |
...
| 2026-08-13 | `docs/rulings/RULINGS.md` | 146 | - `docs/CONTENT_DISTRIBUTION_SYSTEM.md:10` -- > **SUPERSEDED, not merely "outdated in spirit", as of 2026-08-13.** Pip ruled |
...
| 2026-08-14 | `docs/rulings/RULINGS.md` | 317 | - `godot/tests/unit/simulation/test_events.gd:50` -- ## THE RATCHET WAS DELIBERATELY LOOSENED -- 2026-08-14, ruled by Pip, for content velocity. |
...
| 2026-08-15 | `docs/rulings/RULINGS.md` | 144 | - `CLAUDE.md:254` -- `UNDECLARED`, never dropped. **Cross-repo by design** (ruled 2026-08-15): |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 291 | - `godot/data/asset_provenance.json:5132` -- "why": "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and is the only evidence th |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 340 | - `tools/art_review/serve_review.py:205` -- "to element: -- ruled by Pip 2026-08-15 because the sweeps are mostly " |
| 2026-08-15 | `docs/rulings/RULINGS.md` | 343 | - `tools/assets/backfill_provenance.py:479` -- "Ruled by Pip 2026-08-15. A signed credential outranks every heuristic and " |
...
| 2026-08-17 | `docs/rulings/RULINGS.md` | 98 | \| 2026-08-17 \| the game has ONE font-size lever (theme/base_theme.tres default_font_size, registered as the project theme) and a raw size override is  |
...
| 2026-08-19 | `docs/rulings/RULINGS.md` | 292 | - `godot/data/asset_provenance.json:5138` -- "why": "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this manifest answered only WH |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 293 | - `godot/data/asset_provenance.json:5150` -- "why": "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this manifest answered only WH |
| 2026-08-19 | `docs/rulings/RULINGS.md` | 345 | - `tools/assets/backfill_provenance.py:673` -- "Ruled by Pip 2026-08-19 (D2). ADR-0019 has no provenance field and this " |
...
| 2026-08-20 | `docs/rulings/RULINGS.md` | 170 | - `docs/art/A4_COLLAPSE_2026-08-20.md:3` -- **2026-08-20, `pdoom1` seat on New-Bort.** Ruled by Pip: canonicalise on the write |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 330 | - `tools/art_review/ORPHANS_2026-08-15.md:65` -- **A4: RULED 2026-08-20 and DONE.** Canonicalise on the write path and collapse the |
| 2026-08-20 | `docs/rulings/RULINGS.md` | 334 | - `tools/art_review/collapse_px_keys.py:4` -- ORPHANS A4. Ruled by Pip 2026-08-20: canonicalise on the write path AND collapse |
...
| 2026-08-21 | `docs/rulings/RULINGS.md` | 324 | - `scripts/generate_rulings.py:164` -- # CONSOLIDATION, ruled by Pip 2026-08-21. |
...
| 2026-08-22 | `docs/rulings/RULINGS.md` | 228 | - `docs/game-design/DESPERATION_LEVER_PRICING.md:3` -- **Ruled by Pip, 2026-08-22:** *"we need to give the mechanical inertness a definite |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 307 | - `godot/scripts/core/researcher.gd:190` -- # Ruled by Pip 2026-08-22 (#1247): "real STAFF, but they might not eg produce |
| 2026-08-22 | `docs/rulings/RULINGS.md` | 319 | - `godot/tests/unit/test_compute_engineers_are_staff.gd:12` -- ## Ruled by Pip 2026-08-22: "real STAFF, but they might not eg produce as much |
...
| 2026-08-31 | `docs/rulings/RULINGS.md` | 306 | - `godot/scripts/core/researcher.gd:150` -- # SEAM (ruled 2026-07-27, review-by 2026-08-31): AUDITS ground-truth reported vs actual. |
| 2026-08-31 | `docs/rulings/RULINGS.md` | 311 | - `godot/scripts/core/turn_manager.gd:313` -- SEAM (ruled 2026-07-27, review-by 2026-08-31): AUDITS ground-truth reported vs actual. |
