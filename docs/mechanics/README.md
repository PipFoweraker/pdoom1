...
Player-facing documentation for P(Doom) game mechanics. These pages are synced to the [pdoom-website](https://pdoom1.com) for easy player reference.
...
### Game Systems
- **Action Points (AP)** - 3 AP per turn for taking actions
- **Turn Phases** - How each turn progresses
- **Events** - Random events and rival lab actions
...
*These mechanics pages are maintained in the [pdoom1 repository](https://github.com/PipFoweraker/pdoom1) and automatically synced to the website.*
