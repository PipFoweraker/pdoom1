...
> League-close ceremony, stage gates, and the Thu/Fri shape now live in
> `LEAGUE_WEEK_PLAYBOOK.md` (v0, authored Tue evening) -- the runsheet stays
> SSOT for Wednesday's workshop blocks.
