...
- **Date:** 2026-07-04
- **Summary:** SA is the flagship sink for the source-rich/sink-poor economy -- spending money/reputation buys visibility into doom sources.
...
- Granular doom-counting: **re-tag confirmed** -- simulate everything, gate only the view
  (ADR-0004 section 1). No new subsystem.
...
- Measurement: still owed; folds naturally into the seed-vetting harness (ADR-0005) and
  decision-flip telemetry (ADR-0004 section 4).
