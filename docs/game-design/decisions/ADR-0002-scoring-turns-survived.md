...
- **Date:** 2026-07-04
- **Summary:** Replaces the three-copy ad hoc score formula with turns-survived as primary, a doom-integral tiebreak, and no money/hoarding term.
- **Session:** Fable workshop #1

## Context

The implemented score formula -- `(100-doom)x1000 + papersx5000 + researchersx2000 +
turnx500 + moneyx0.1 + 50,000 victory bonus (doom<20)` -- was scaffolding built to test
