...
def demonstrate_cascade_system():
    ...
    print(
        f"Incident Response Training: {'Success' if success else 'Failed'} (Level {cascade_system.incident_response_level})"
    )

    # Upgrade monitoring
    success = cascade_system.upgrade_monitoring_systems(40)
    print(
        f"Monitoring Systems: {'Success' if success else 'Failed'} (Level {cascade_system.monitoring_systems})"
    )

    # Upgrade communication
    success = cascade_system.upgrade_communication_protocols(25)
    print(
        f"Communication Protocols: {'Success' if success else 'Failed'} (Level {cascade_system.communication_protocols})"
    )
    ...
    print("  Transparency reputation: +0.5 (builds over time)")
    ...
    print("  Money: -$30k (cover-up costs)")
    print("  Cover-up debt: +5 (increases future failure risk)")
    ...
    total_investment = (
        summary["incident_response_level"] * 30
    ...
    print("ROI from prevention: 200%+ (not including reputation benefits)")
    print()
