...
EVENTS: List[EventDefinition] = [
    {
        ...
        'trigger': lambda gs: gs.doom > 35 and get_rng().random('random_context') < gs.doom / 120,
        'effect': lambda gs: gs._breakthrough_event()
    },
    {
        'name': 'Funding Crisis',
        'desc': 'Major donor pulls out, lose money.',
        'trigger': lambda gs: gs.money < 80 and get_rng().random('random_context') < 0.2,
        'effect': lambda gs: gs._add('money', -get_rng().randint(40, 100, 'randint_context'))
    },
    {
        'name': 'Staff Burnout',
        'desc': 'Overworked staff quit.',
        'trigger': lambda gs: gs.staff > 6 and gs.money < gs.staff * gs.staff_maintenance and get_rng().random('random_context') < 0.2,
        'effect': lambda gs: gs._add('staff', -get_rng().randint(1, 2, 'randint_context'))
    },
    {
    ...
    },
    {
        ...
        'trigger': lambda gs: gs.turn >= 3 and get_rng().random('random_context') < (0.05 + gs.doom / 1000),
    ...
    },
    {
        ...
        'trigger': lambda gs: gs.staff >= 2 and get_rng().random('random_context') < (0.1 + gs.staff * 0.01),
    ...
    # Enhanced Personnel System Events
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) > 0 and 
                              get_rng().random('random_context') < len(gs.researchers) * 0.03),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) > 0 and 
                              any(r.burnout > 60 for r in gs.researchers) and get_rng().random('random_context') < 0.15),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) > 0 and 
                              gs.turn > 3 and get_rng().random('random_context') < len(gs.researchers) * 0.02),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) > 0 and 
                              ...
                              gs.doom > 40 and get_rng().random('random_context') < 0.1),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) > 0 and 
                              ...
                              gs.reputation > 15 and get_rng().random('random_context') < 0.08),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) >= 2 and 
                              gs.reputation > 20 and get_rng().random('random_context') < 0.06),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) > 1 and 
                              sum(1 for r in gs.researchers if r.loyalty < 30) >= 2 and get_rng().random('random_context') < 0.12),
    ...
    },
    {
        ...
        'trigger': lambda gs: (gs.technical_debt.accumulated_debt >= 8 and 
                              ...
                              get_rng().random('random_context') < 0.20),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'researchers') and len(gs.researchers) >= 2 and 
                              gs.turn >= 8 and get_rng().random('random_context') < 0.10),
    ...
    },
    {
        ...
        'trigger': lambda gs: (gs.turn >= 10 and 
                              ...
                              get_rng().random('random_context') < 0.12),
    ...
    # Economic Cycles & Funding Volatility Events for Issue #192
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'economic_cycles') and 
                              ...
                              gs.turn % 15 == 0 and get_rng().random('random_context') < 0.3),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'economic_cycles') and 
                              ...
                              gs.turn > 50 and get_rng().random('random_context') < 0.15),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'economic_cycles') and 
                              gs.economic_cycles.current_state.phase.name in ['RECESSION', 'CORRECTION'] and
                              gs.reputation >= 12 and get_rng().random('random_context') < 0.12),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'economic_cycles') and 
                              ...
                              gs.money < gs.staff * 50 and get_rng().random('random_context') < 0.25),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'economic_cycles') and 
                              ...
                              get_rng().random('random_context') < 0.1),
    ...
    },
    {
        ...
        'trigger': lambda gs: (hasattr(gs, 'technical_failures') and 
                              ...
                              get_rng().random('random_context') < gs.technical_failures.cover_up_debt * 0.02),
